...
export const metadata = {
  title: "Quiniela LaLiga 2026-27 | Soy Reinaldo",
  description:
...
/** Jornada por defecto: la del próximo partido por jugarse; si la temporada
 * ya terminó, la última jugada. */
...
export default async function QuinielaLigaPage({
  searchParams,
}: {
  ...
  if (!user) redirect("/login?redirect=/quiniela-liga");
