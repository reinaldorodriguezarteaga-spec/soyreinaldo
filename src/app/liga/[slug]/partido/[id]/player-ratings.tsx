...
/**
 * Valoraciones de jugadores (vista de campo + vista de lista) del detalle de
 * partido. Idéntico a `mundial/partido/[id]/player-ratings.tsx` (ya era
 * competición-agnóstico, no tiene ningún enlace ni texto específico del
 * Mundial) — copiado a su propio archivo para que /mundial quede intacto.
 */
