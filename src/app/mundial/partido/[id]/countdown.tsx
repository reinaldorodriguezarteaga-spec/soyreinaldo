...
/**
 * Cuenta atrás hasta el inicio de un partido. Se monta solo en el cliente
 * (empieza en null para no romper la hidratación con la hora del servidor) y
 * actualiza cada segundo desde un timer — sin setState síncrono en el cuerpo
 * del efecto.
 */
export default function Countdown({ kickoff }: { kickoff: string }) {
  ...
  useEffect(() => {
    // Primer valor tras el paint (callback, no cuerpo del efecto) + tick 1s.
