-- =============================================================================
-- Quitar el pick "total de hat-tricks" del scoring
-- =============================================================================
-- La columna hat_tricks_count se mantiene en user_picks y tournament_results
-- (preservación de datos) pero ya no suma puntos en el leaderboard.
-- =============================================================================
