-- =============================================================================
-- Quitar puntos de top_scoring_team y least_conceded_team
-- =============================================================================
-- Las columnas `top_scoring_team` y `least_conceded_team` se mantienen en
-- `user_picks` y `tournament_results` (preservación de datos), pero la
-- función de scoring ya no les asigna puntos.
-- =============================================================================
