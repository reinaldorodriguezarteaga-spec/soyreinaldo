-- =============================================================================
-- Tercer lugar: 7 → 3 puntos
-- =============================================================================
-- Solo cambia el valor del pick "tercer lugar" en el scoring. Todo lo demás
-- de league_leaderboard queda idéntico a migration 021.
-- =============================================================================
  ...
  pick_scores as (
    select
      ...
      + (case when up.tercer_lugar is not null
                and up.tercer_lugar = tr.tercer_lugar then 3 else 0 end)
